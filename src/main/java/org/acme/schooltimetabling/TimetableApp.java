...
public class TimetableApp {
        ...
        private static String getTimeslotDayPart(Timeslot timeslot) {
        ...
        private static void printTimetable(Timetable timetable) {
                ...
                int currentDayPart = -1;
                // Print each timeslot row
                for (Timeslot timeslot : timetable.getTimeslots()) {
                        if (timeslot.getDayPart() != currentDayPart) {
                                currentDayPart = timeslot.getDayPart();
                                LOGGER.info("PART OF THE DAY: " + getTimeslotDayPart(timeslot));
                        }
